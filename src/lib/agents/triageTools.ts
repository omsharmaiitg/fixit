  ...
  declaration: {
    ...
    parametersJsonSchema: {
      ...
      properties: {
        ...
        description: { type: 'string', description: "Clear description in the user's language" },
        descriptionEnglish: { type: 'string', description: 'English translation if original is not English' },
        lat: { type: 'number' },
        lng: { type: 'number' },
        address: { type: 'string' },
        language: { type: 'string', description: "BCP-47 code of the user's language, e.g. 'hi-IN'" },
      },
